...
def make_annot_files(args, bed_for_annot):
    ...
    ########################################################
    # BOR: Strangely, somehow SNPs can rarely get duplicated here which
    # causes bugs later on in partitioning heritability. Deduplicate them here:
    df_annot = df_annot.drop_duplicates(subset=['SNP'])
